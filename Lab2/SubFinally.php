...
//Метод проверки телефона
        ...
        jQuery.validator.addMethod("phoneValue", correctPhone(), "Введите номер телефона!");
...
<div id="ask_yurist">
    ...
    <div class="body">
        <form id="ContactForm" name="ContactForm" onsubmit="return correctPhone()" method="post" action="">
            <fieldset class="contacts">
                ...
                <p>
                    <label for="phone">Телефон <em>*</em></label><input type="text" id="phone" name="phone"  placeholder="+*(***)***.**.**" required>
                </p>
            </fieldset>
            <fieldset class="face">
                <legend>Лицо</legend>
