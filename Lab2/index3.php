    ...
    <div class="body">
        <form id="ContactForm" name="ContactForm" method="post" action="">
            <fieldset class="contacts">
                ...
                <p>
                    <label for="phone">Телефон <em>*</em></label><input type="text" id="phone" name="phone" autofocus="autofocus" pattern="\+\[0-9]{1}\[(]\[)]\[0-9]{3}\[0-9]{3}\.[0-9]{2}\.[0-9]{2}" placeholder="+7(___)___.__.__" required>
                </p>
            </fieldset>
            <fieldset class="face">
                <legend>Лицо</legend>
